/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc apps/worker/src/worker-configuration.d.ts` (hash: edc5c45d6b053b0e87b3f365cb56c766)
// Runtime types generated with workerd@1.20260722.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	ATTACHMENTS: R2Bucket;
	DB: D1Database;
	VECTORIZE_MEMOS: VectorizeIndex;
